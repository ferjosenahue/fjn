...
setConfig("useMouseEnterToExpand", false);
...
function setFormatSize (){
	...
	$('#SwiffyCollapsedState').css("width",config.collapsedWidth);
	$('#SwiffyCollapsedState').css("height", config.collapsedHeight);
	$('#SwiffyExpandedState').css("width", config.expandedWidth);
	$('#SwiffyExpandedState').css("height", config.expandedHeight);
}
...
/**
* Set the MouseEnter and MouseLeave events.
**/
$("#InpageSection").mouseenter(function() {
    if (config.useMouseEnterToExpand)
    {
		doExpand(true);
    }
});
$("#InpageSection").mouseleave(function() {
    if (config.useMouseEnterToExpand)
    {
		doCollapse(true);
    }
