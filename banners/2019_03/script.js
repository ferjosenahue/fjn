...
if (reversed == null) { reversed = false; }
	...
	// arrow
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#C1CBBA").s().p("AhTAHIADgGIgth6IBfAvICcBMIj7B4g");
	this.shape.setTransform(264.45,20.025);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	// Layer 1
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AhmBwIAAjfIBXAAQAiAAAbAPQAbAOAPAaQAPAZAAAfIAAAAQAAAggPAZQgPAZgbAPQgbAPgiAAgAg1BEIAmAAQATAAAPgJQAQgIAIgQQAIgOAAgVIAAAAQAAgTgIgPQgIgPgQgJQgPgIgTAAIgmAAg");
	this.shape_1.setTransform(234.675,25.45);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AAnBwIgvhHIgnAAIAABHIgxAAIAAjfIBlAAQAWAAAQAGQARAFALAMQAJAJAFANQAFANAAAQIAAAAQAAAbgNARQgNARgWAIIA3BQgAgvgCIAxAAQASAAAKgJQAKgIAAgPIAAgBQAAgQgKgHQgKgJgTABIgwAAg");
	this.shape_2.setTransform(210.275,25.45);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("ABDBxIgUgyIheAAIgUAyIgzAAIBgjhIAtAAIBgDhgAAdATIgdhIIgdBIIA6AAg");
	this.shape_3.setTransform(184.625,25.375);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AgvBkQgZgPgPgaQgPgaAAghIAAAAQAAgfAPgaQAOgaAbgQQAagPAhgBQAgABAVAIQAVAKAPAPIggAlQgMgMgOgHQgOgHgRAAQgSAAgPAKQgOAKgIAPQgJAQAAATIAAAAQAAATAIAQQAJAQAOAKQAPAJASAAQATABAOgIQANgGANgNIAfAgQgLAMgNAJQgNAJgRAFQgQAFgWAAQggAAgagQg");
	this.shape_4.setTransform(159.825,25.45);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AhUBwIAAjfICoAAIAAAsIh3AAIAAAuIBoAAIAAAqIhoAAIAAAvIB4AAIAAAsg");
	this.shape_5.setTransform(126.775,25.45);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AAuBwIAAhaIhaAAIAABaIgyAAIAAjfIAyAAIAABZIBaAAIAAhZIAwAAIAADfg");
	this.shape_6.setTransform(102.8,25.45);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AgYBwIAAixIhEAAIAAguIC5AAIAAAuIhEAAIAACxg");
	this.shape_7.setTransform(79.675,25.45);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AgYBwIAAixIhEAAIAAguIC5AAIAAAuIhEAAIAACxg");
	this.shape_8.setTransform(48.125,25.45);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AhUBwIAAjfICoAAIAAAsIh3AAIAAAuIBoAAIAAAqIhoAAIAAAvIB4AAIAAAsg");
	this.shape_9.setTransform(26.925,25.45);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AgyBlQgagPgPgaQgPgaAAgiIAAAAQAAgfAQgaQAPgaAagQQAagPAigBQAUAAAPAEQAQADAMAHQANAHAMAKIggAlQgMgKgNgHQgOgFgTgBQgRAAgPAKQgOAKgJAPQgIAQAAATIAAAAQAAAVAIAPQAJARAPAIQAPAKATAAQAOAAAMgDQAMgEAJgGIAAghIgyAAIAAgpIBiAAIAABgQgSAPgYALQgXAKgfAAQgiAAgbgPg");
	this.shape_10.setTransform(2.375,25.45);
...
}).prototype = getMCSymbolPrototype(lib.learnMore, new cjs.Rectangle(-12,4,289.1,42.4), null);
...
// stage content:
(lib._2019GMCardBrandBuyPowerCardMRMProgrammaticNoneGetTheCardCTANoneH5SUSENGv1300x250 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
